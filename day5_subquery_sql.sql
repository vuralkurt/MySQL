...
==============================================================================*/   
 ...
 select marka_isim,calisan_sayisi,(select round(AVG(maas)) from calisanlar
													where markalar.marka_isim=calisanlar.isyeri) as ORT_maas
 from markalar;
...
(select MAX(maas) from calisanlar where markalar.marka_isim=calisanlar.isyeri) as max_maas,
(select MIN(maas) from calisanlar where markalar.marka_isim=calisanlar.isyeri) as min_maas
 from markalar;
