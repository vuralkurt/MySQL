...
/*======================= CONSTRAINTS - KISITLAMALAR ======================================
 ...
 CREATE TABLE calisanlar
    (
        id CHAR(5) PRIMARY KEY,     -- not null+ unique    NOT NULL+UNIQUE
    ...
    INSERT INTO calisanlar VALUES('10008', null, 5000, '2018-04-14');         -- null UNIQUE engel degil
    INSERT INTO calisanlar VALUES('10004', 'Veli Han', 5000, '2018-04-14');
    INSERT INTO calisanlar VALUES('10005', 'Mustafa Ali', 5000, '2018-04-14'); 
    INSERT INTO calisanlar VALUES('10006', 'Canan Yaş', NULL, '2019-04-12'); -- maas null olamaz
    INSERT INTO calisanlar VALUES('10003', 'CAN', 5000, '2018-04-14');
    INSERT INTO calisanlar VALUES('10007', 'CAN', 5000, '2018-04-14'); -- can ismi zaten var  UNIQUE
    INSERT INTO calisanlar VALUES('10009', 'cem', '', '2018-04-14'); -- tirnakli integer yazilmaz
    INSERT INTO calisanlar VALUES('', 'cemil', 2000, '2018-04-14');  -- hiclik "string"de bir degerdir
    INSERT INTO calisanlar VALUES('10018', null, 5000, '2018-04-14'); -- 2. null benzersiz kisitlamasini bozmaz
...
-- baglamak icin babada primary key olacak.
----------------------------------------------------------------*/
    ...
    (
        ...
        cadde VARCHAR(30),
        sehir VARCHAR(15),
        CONSTRAINT id_fenerbahce FOREIGN KEY(adres_id) REFERENCES calisanlar(id) -- (solda tablo seçiliyken üstteki info dan ismi kontrol edebilirsin)
    );
    
    INSERT INTO adresler VALUES('10008','Mutlu Sok', '40.Cad.','IST');
    INSERT INTO adresler VALUES('10002','Can Sok', '50.Cad.','Ankara');
    INSERT INTO adresler VALUES('10002','Ağa Sok', '30.Cad.','Antep');
    -- parent tabloda olmayan id ile childa ekleme yapamayiz
...
==============================================================================*/ 
 ...
 CREATE TABLE talebeler
   ...
   DELETE FROM talebeler WHERE id = '124';   -- tabloyutamamen silemem ama tek tek bu sekilde silebilrim
