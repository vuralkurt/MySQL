...
==============================================================================*/
  ...
  /*--------------------------------- 
  ÖRNEK 1:ismi "null" olanlari bul.
  -----------------------------------*/
  
  select * from insanlar where isim is null;
  
 /* ---------------------------------------- 
 ÖRNEK 2:isminde "null" olmayanlari bul.alter
 -------------------------------------------*/
...
==============================================================================*/       
 ...
 -----------------------------------------------------------------------------*/ 
   ...
   select * from kisiler  order by adres;
    ...
    /* ----------------------------------------------------------------------------
  ORNEK1: kisiler tablosunu maas#a ters göre sıralayarak sorgulayınız.
 -----------------------------------------------------------------------------*/ 
...
-----------------------------------------------------------------------------*/ 
  ...
  -- ******************************LIMIT******************************************
   ...
   -- 1. SORU: listeden ilk 10 veriyi getir
   
   select* from kisiler limit 5;
   
   -- 2: SORU: 5. veriden sonraki 2 veriyi(6. ve 7.) al.
   select * from kisiler limit 5,2;
   select*from kisiler where id>5 limit 2;
   
   /* ----------------------------------------------------------------------------
  ORNEK 3: MAAŞ'ı en yüksek 3 kişinin bilgilerini listeleyen sorguyu yazınız.
-----------------------------------------------------------------------------*/
