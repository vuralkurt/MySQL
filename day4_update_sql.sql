...
==============================================================================*/  
   ...
   CREATE TABLE tedarikciler
    ...
    -- WHERE koşul;
      ...
      select * from tedarikciler , urunler where vergi_no = urunler.ted_vergino;
...
/* -----------------------------------------------------------------------------
  ...
  güncelleyeniz. 
 -----------------------------------------------------------------------------*/ 
  update tedarikciler set firma_ismi='casper' where vergi_no; 
...
/* -----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/ 
    ...
    select * from tedarikciler;
   -- and kullanmadan virgül de kullanilabilir. 
...
/* -----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/ 
   update tedarikciler set irtibat_ismi='Vural Kurt' where firma_ismi='casper';
   select * from tedarikciler;
