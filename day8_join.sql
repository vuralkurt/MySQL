...
------------------------------------------------------------------------------*/  
    ...
    select sirketler.sirket_isim,siparisler.siparis_id,siparisler.siparis_tarihi,siparisler.sirket_id
    from sirketler
...
left join personel p
on p.bolum_id=b.bolum_id
-- where b.bolum_id in(10,20,30,40,50)
...
select p.personel_isim,b.bolum_isim,p.maas,(select personel_isim from personel where p.mudur_id=personel_id) dd
from bolumler b
